...
#include <jni.h>
/* Header for class com_chivan_decoder_Mp3Encoder */

#ifndef _Included_com_chivan_decoder_Mp3Encoder
#define _Included_com_chivan_decoder_Mp3Encoder
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_chivan_decoder_Mp3Encoder
 * Method:    init
